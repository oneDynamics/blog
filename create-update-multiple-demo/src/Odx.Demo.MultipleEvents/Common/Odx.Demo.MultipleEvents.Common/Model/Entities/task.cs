...
namespace Odx.Demo.MultipleEvents.Common.Model
{
	...
	public partial class Task : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Odx.Demo.MultipleEvents.Common.Model.Contact Contact_Tasks
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.MultipleEvents.Common.Model.Contact>("Contact_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_Tasks");
				this.SetRelatedEntity<Odx.Demo.MultipleEvents.Common.Model.Contact>("Contact_Tasks", null, value);
		...
		public Odx.Demo.MultipleEvents.Common.Model.SystemUser lk_task_createdby
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.MultipleEvents.Common.Model.SystemUser>("lk_task_createdby", null);
			}
		}
		...
		public Odx.Demo.MultipleEvents.Common.Model.SystemUser lk_task_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.MultipleEvents.Common.Model.SystemUser>("lk_task_createdonbehalfby", null);
			}
		}
		...
		public Odx.Demo.MultipleEvents.Common.Model.SystemUser lk_task_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.MultipleEvents.Common.Model.SystemUser>("lk_task_modifiedby", null);
			}
		}
		...
		public Odx.Demo.MultipleEvents.Common.Model.SystemUser lk_task_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.MultipleEvents.Common.Model.SystemUser>("lk_task_modifiedonbehalfby", null);
			}
		}
		...
		public Odx.Demo.MultipleEvents.Common.Model.SystemUser user_task
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.MultipleEvents.Common.Model.SystemUser>("user_task", null);
			}
		}
	}
}
