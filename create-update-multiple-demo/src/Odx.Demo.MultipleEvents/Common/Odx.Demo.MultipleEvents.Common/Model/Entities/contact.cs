...
namespace Odx.Demo.MultipleEvents.Common.Model
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<System.DateTime> odx_Nextcontactdate
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("odx_nextcontactdate");
			}
			set
			{
		...
		public System.Collections.Generic.IEnumerable<Odx.Demo.MultipleEvents.Common.Model.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<Odx.Demo.MultipleEvents.Common.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<Odx.Demo.MultipleEvents.Common.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Odx.Demo.MultipleEvents.Common.Model.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<Odx.Demo.MultipleEvents.Common.Model.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<Odx.Demo.MultipleEvents.Common.Model.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public Odx.Demo.MultipleEvents.Common.Model.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.MultipleEvents.Common.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<Odx.Demo.MultipleEvents.Common.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public Odx.Demo.MultipleEvents.Common.Model.Contact Referencingcontact_master_contact
		{
			get
			{
