...
namespace Odx.Demo.Model
{
	...
	public partial class ActivityParty : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Odx.Demo.Model.Account account_activity_parties
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.Model.Account>("account_activity_parties", null);
			}
			set
			{
				this.OnPropertyChanging("account_activity_parties");
				this.SetRelatedEntity<Odx.Demo.Model.Account>("account_activity_parties", null, value);
		...
		public Odx.Demo.Model.Email email_activity_parties
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.Model.Email>("email_activity_parties", null);
			}
			set
			{
				this.OnPropertyChanging("email_activity_parties");
				this.SetRelatedEntity<Odx.Demo.Model.Email>("email_activity_parties", null, value);
		...
		public Odx.Demo.Model.Opportunity opportunity_activity_parties
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.Model.Opportunity>("opportunity_activity_parties", null);
			}
			set
			{
				this.OnPropertyChanging("opportunity_activity_parties");
				this.SetRelatedEntity<Odx.Demo.Model.Opportunity>("opportunity_activity_parties", null, value);
		...
		public Odx.Demo.Model.SystemUser system_user_activity_parties
		{
			get
			{
				return this.GetRelatedEntity<Odx.Demo.Model.SystemUser>("system_user_activity_parties", null);
			}
			set
			{
				this.OnPropertyChanging("system_user_activity_parties");
				this.SetRelatedEntity<Odx.Demo.Model.SystemUser>("system_user_activity_parties", null, value);
